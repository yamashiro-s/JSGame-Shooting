...
document.write('<script type="text/javascript" src="js/main.js" charset="shift_jis"></script>');

document.write('<script type="text/javascript" src="js/character.js"></script>');
document.write('<script type="text/javascript" src="js/chara_shot.js"></script>');
